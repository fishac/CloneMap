...
public class FinallyTreeNodeAnalyzer extends TreeNodeAnalyzer {

	public FinallyTreeNodeAnalyzer(Node rootNode, Node currentNode, CompilationUnit cUnit, String classPath,
