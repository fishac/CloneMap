...
public class PostfixExpressionTreeNodeAnalyzer extends TreeNodeAnalyzer {


	public PostfixExpressionTreeNodeAnalyzer(Node rootNode, Node currentNode, CompilationUnit cUnit, String classPath,
